...
"""
Demo Mode Script
Loads demo configuration for showcasing PartnerAgents.
...
def activate_demo_mode():
    ...
    config_content = f"""# PartnerAgents Demo Configuration
...
def main():
    ...
    parser = argparse.ArgumentParser(description="PartnerAgents Demo Mode")
