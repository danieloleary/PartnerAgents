...
Helps new companies set up PartnerAgents for their use.
...
def print_header():
    print("\n" + "=" * 60)
    print("  PartnerAgents Company Onboarding")
    print("  Set up PartnerAgents for your company")
    print("=" * 60 + "\n")
...
def get_company_info():
    ...
    print("Let's set up PartnerAgents for your company!\n")
...
def create_config_file(info):
    ...
    config_content = f"""# PartnerAgents Company Configuration
...
def main():
    ...
    if CONFIG_FILE.exists():
        response = (
            input(f"PartnerAgents is already configured. Reconfigure? (y/N): ")
            .strip()
            .lower()
        )
        if response != "y":
